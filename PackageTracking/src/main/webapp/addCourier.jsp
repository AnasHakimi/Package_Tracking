...
<div class="con">
    <h1>Add Courier</h1>
   <form action="AddCourier" method="post" enctype="multipart/form-data">
    <div class="form-group">
        <label for="courier">Courier :</label>
        <input type="text" id="courier" name="courier_name" required>
    </div>
    <div class="form-group">
        <label for="courier-logo">Courier Logo :</label>
        <input type="file" id="courier-logo" name="courier_logo" required>
    </div>
    <div class="form-group">
        <label for="courier-availability">Courier Availability:</label>
        <div class="availability">
            <input type="radio" id="available" name="courier_availability" value="Available">
            <label for="available" class="available-label">Available ✔️</label>
            <input type="radio" id="unavailable" name="courier_availability" value="Unavailable">
